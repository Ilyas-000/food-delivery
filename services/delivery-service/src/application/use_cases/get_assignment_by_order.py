"""Get assignment by order use case."""
...
class GetAssignmentByOrderUseCase:
    ...
    async def execute(self, order_id: UUID) -> DeliveryAssignmentResponseDTO:
        """Return assignment snapshot for given order."""
        ...
        return DeliveryAssignmentResponseDTO.from_entity(assignment)
